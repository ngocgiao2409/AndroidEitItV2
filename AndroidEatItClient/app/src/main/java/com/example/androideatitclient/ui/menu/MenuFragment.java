...
import com.example.androideatitclient.Adapter.MyCategoriesAdapter;
import com.example.androideatitclient.Common.Common;
import com.example.androideatitclient.Common.SpacesItemDecoration;
        ...
        layoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                if (adapter != null)
                {
                    ...
                    {
                        case Common.DEAFAULT_COLUMN_COUNT: return 1;
